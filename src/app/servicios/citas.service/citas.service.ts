...
export class CitasService 
{
  ...
  [ 
    ...
    { id: 3, idMascota: 2, fecha: '2026-03-01', hora:'09:00', motivo: 'Revisión general' }, 
    { id: 4, idMascota: 3, fecha: '2026-05-05', hora:'11:30', motivo: 'Peluquería' }, 
    { id: 5, idMascota: 4, fecha: '2026-07-12', hora:'13:30', motivo: 'Limpieza dental' }, 
    { id: 6, idMascota: 4, fecha: '2026-08-01', hora:'15:30', motivo: 'Análisis de sangre' }, 
    { id: 7, idMascota: 5, fecha: '2026-02-25', hora:'09:00', motivo: 'Revisión general' }, 
    ...
    { id: 10, idMascota: 8, fecha: '2026-11-15', hora:'16:30', motivo: 'Revisión general' }, 
    { id: 11, idMascota: 10, fecha: '2027-01-20', hora:'13:30', motivo: 'Peluquería' }, 
    { id: 12, idMascota: 11, fecha: '2027-02-14', hora:'15:30', motivo: 'Revisión general' }, 
